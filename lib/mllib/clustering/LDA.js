...
function LDA() {
  if (arguments.length == 2) {
    ...
    var templateStr = 'var {{refId}} = new LDA();';

    this.refIdP = Utils.evaluate(gKernelP, LDA, templateStr, null, true);
  }
}
...
LDA.prototype.setK = function(k) {
  ...
  return Utils.generateAssignment(this, LDA, templateStr, {k: k});
};
...
LDA.prototype.getAsymmetricDocConcentration = function() {
  throw "not implemented by ElairJS";
//
// var templateStr = 'var {{refId}} = {{inRefId}}.getAsymmetricDocConcentration();';
//
...
// };
//
// var templateStr = '{{inRefId}}.getDocConcentration();';
// return Utils.generateResultPromise(this, templateStr  , _resolve);
};
...
LDA.prototype.setDocConcentrationwithVector = function(docConcentration) {
  throw "not implemented by ElairJS";
//
// var templateStr = 'var {{refId}} = {{inRefId}}.setDocConcentration({{docConcentration}});';
//
// return Utils.generateAssignment(this, , templateStr , {docConcentration : docConcentration});
};
...
LDA.prototype.getAsymmetricAlpha = function() {
  throw "not implemented by ElairJS";
//
// var templateStr = 'var {{refId}} = {{inRefId}}.getAsymmetricAlpha();';
//
// return Utils.generateAssignment(this, Vector, templateStr );
};
...
// };
//
// var templateStr = '{{inRefId}}.getAlpha();';
// return Utils.generateResultPromise(this, templateStr  , _resolve);
};
...
// };
//
// var templateStr = '{{inRefId}}.getTopicConcentration();';
// return Utils.generateResultPromise(this, templateStr  , _resolve);
};
...
LDA.prototype.setTopicConcentration = function(topicConcentration) {
  throw "not implemented by ElairJS";
//
// var templateStr = 'var {{refId}} = {{inRefId}}.setTopicConcentration({{topicConcentration}});';
//
// return Utils.generateAssignment(this, , templateStr , {topicConcentration : topicConcentration});
};
...
// };
//
// var templateStr = '{{inRefId}}.getBeta();';
// return Utils.generateResultPromise(this, templateStr  , _resolve);
};
...
LDA.prototype.setBeta = function(beta) {
  throw "not implemented by ElairJS";
//
// var templateStr = 'var {{refId}} = {{inRefId}}.setBeta({{beta}});';
//
// return Utils.generateAssignment(this, , templateStr , {beta : beta});
};
...
// };
//
// var templateStr = '{{inRefId}}.getCheckpointInterval();';
// return Utils.generateResultPromise(this, templateStr  , _resolve);
};
...
LDA.prototype.setCheckpointInterval = function(checkpointInterval) {
  throw "not implemented by ElairJS";
//
// var templateStr = 'var {{refId}} = {{inRefId}}.setCheckpointInterval({{checkpointInterval}});';
//
// return Utils.generateAssignment(this, , templateStr , {checkpointInterval : checkpointInterval});
};
...
LDA.prototype.setOptimizer = function(optimizerName) {
  throw "not implemented by ElairJS";
//
// var templateStr = 'var {{refId}} = {{inRefId}}.setOptimizer({{optimizerName}});';
//
// return Utils.generateAssignment(this, , templateStr , {optimizerName : optimizerName});
};

/**
 * Learn an LDA model using the given dataset.
 *
 * @param {RDD} documents   RDD of documents, which are term (word) count vectors paired with IDs.
...
LDA.prototype.run = function(documents) {
  var templateStr = 'var {{refId}} = {{inRefId}}.run({{documents}});';

  return Utils.generateAssignment(this, LDAModel, templateStr, {documents: Utils.prepForReplacement(documents)});
};
