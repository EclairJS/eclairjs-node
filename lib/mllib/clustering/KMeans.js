...
function KMeans(kernelP, refIdP) {
  if (kernelP && refIdP) {
    ...
    var templateStr = 'var {{refId}} = new KMeans();';

    this.refIdP = Utils.evaluate(gKernelP, KMeans, templateStr, null, true);
  }
}
...
//
// return Utils.generateAssignment(this, , templateStr , {k : k});
};
...
// };
//
// var templateStr = '{{inRefId}}.getInitializationMode();';
// return Utils.generateResultPromise(this, templateStr  , _resolve);
};
...
KMeans.prototype.setInitializationMode = function(initializationMode) {
  throw "not implemented by ElairJS";
//
// var templateStr = 'var {{refId}} = {{inRefId}}.setInitializationMode({{initializationMode}});';
//
// return Utils.generateAssignment(this, , templateStr , {initializationMode : initializationMode});
};
...
// };
//
// var templateStr = '{{inRefId}}.getRuns();';
// return Utils.generateResultPromise(this, templateStr  , _resolve);
};
...
KMeans.prototype.setRuns = function(runs) {
  throw "not implemented by ElairJS";
//
// var templateStr = 'var {{refId}} = {{inRefId}}.setRuns({{runs}});';
//
// return Utils.generateAssignment(this, , templateStr , {runs : runs});
};
...
// };
//
// var templateStr = '{{inRefId}}.getInitializationSteps();';
// return Utils.generateResultPromise(this, templateStr  , _resolve);
};
...
KMeans.prototype.setInitializationSteps = function(initializationSteps) {
  throw "not implemented by ElairJS";
//
// var templateStr = 'var {{refId}} = {{inRefId}}.setInitializationSteps({{initializationSteps}});';
//
// return Utils.generateAssignment(this, , templateStr , {initializationSteps : initializationSteps});
};
...
// };
//
// var templateStr = '{{inRefId}}.getEpsilon();';
// return Utils.generateResultPromise(this, templateStr  , _resolve);
};
...
KMeans.prototype.setEpsilon = function(epsilon) {
  throw "not implemented by ElairJS";
//
// var templateStr = 'var {{refId}} = {{inRefId}}.setEpsilon({{epsilon}});';
//
// return Utils.generateAssignment(this, , templateStr , {epsilon : epsilon});
};
...
KMeans.prototype.setInitialModel = function(model) {
  throw "not implemented by ElairJS";
//
// var templateStr = 'var {{refId}} = {{inRefId}}.setInitialModel({{model}});';
//
// return Utils.generateAssignment(this, , templateStr , {model : model});
};
...
//
// return Utils.generateAssignment(this, KMeansModel, templateStr , {data : data});
};
...
KMeans.train = function(data,k,maxIterations,runs,initializationMode,seed) {
  ...
  if (seed) {
    templateStr = 'var {{refId}} = KMeans.train({{data}},{{k}},{{maxIterations}},{{runs}},{{initializationMode}},{{seed}});';
  } else if (initializationMode) {
    templateStr = 'var {{refId}} = KMeans.train({{data}},{{k}},{{maxIterations}},{{runs}},{{initializationMode}});';
  } else {
    templateStr = 'var {{refId}} = KMeans.train({{data}},{{k}},{{maxIterations}});';
  }

 return Utils.evaluate(gKernelP, KMeansModel, templateStr, {data: Utils.prepForReplacement(data),k : k,maxIterations : maxIterations,runs : runs,initializationMode : initializationMode,seed : seed});
};
