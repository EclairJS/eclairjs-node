 ...
 * @param {Strategy} strategy  Parameters for training each tree in the forest.
 ...
 */
RandomForest.trainClassifier0 = function(input,strategy,numTrees,featureSubsetStrategy,seed) {
  throw "not implemented by ElairJS";
//
// var templateStr = 'var {{refId}} = RandomForest.trainClassifier({{input}},{{strategy}},{{numTrees}},{{featureSubsetStrategy}},{{seed}});';
//
// return Utils.generateAssignment(this, RandomForestModel, templateStr , {input : input,strategy : strategy,numTrees : numTrees,featureSubsetStrategy : featureSubsetStrategy,seed : seed});
};
 ...
 * @returns {RandomForestModel}  a random forest model  that can be used for prediction
 */
RandomForest.trainClassifier1 = function(input,numClasses,categoricalFeaturesInfo,numTrees,featureSubsetStrategy,impurity,maxDepth,maxBins,seed) {
  throw "not implemented by ElairJS";
//
...
//
// return Utils.generateAssignment(this, RandomForestModel, templateStr , {input : input,numClasses : numClasses,categoricalFeaturesInfo : categoricalFeaturesInfo,numTrees : numTrees,featureSubsetStrategy : featureSubsetStrategy,impurity : impurity,maxDepth : maxDepth,maxBins : maxBins,seed : seed});
};
 ...
 */
RandomForest.trainClassifier2 = function(input,numClasses,categoricalFeaturesInfo,numTrees,featureSubsetStrategy,impurity,maxDepth,maxBins,seed) {
  throw "not implemented by ElairJS";
//
// var templateStr = 'var {{refId}} = RandomForest.trainClassifier({{input}},{{numClasses}},{{categoricalFeaturesInfo}},{{numTrees}},{{featureSubsetStrategy}},{{impurity}},{{maxDepth}},{{maxBins}},{{seed}});';
//
