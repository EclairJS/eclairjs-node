...
function PrefixSpan() {
  if (arguments.length == 2) {
    ...
    var templateStr = 'var {{refId}} = new PrefixSpan();';

    this.refIdP = Utils.evaluate(gKernelP, PrefixSpan, templateStr, null, true);
  }
}
...
// };
//
// var templateStr = '{{inRefId}}.getMinSupport();';
...
PrefixSpan.prototype.setMinSupport = function(minSupport) {
  ...
  return Utils.generateAssignment(this, PrefixSpan, templateStr , {minSupport: minSupport});
};
...
// };
//
// var templateStr = '{{inRefId}}.getMaxPatternLength();';
// return Utils.generateResultPromise(this, templateStr  , _resolve);
};
...
PrefixSpan.prototype.setMaxPatternLength = function(maxPatternLength) {
  var templateStr = 'var {{refId}} = {{inRefId}}.setMaxPatternLength({{maxPatternLength}});';

  return Utils.generateAssignment(this, PrefixSpan, templateStr, {maxPatternLength: maxPatternLength});
};
...
// };
//
// var templateStr = '{{inRefId}}.getMaxLocalProjDBSize();';
// return Utils.generateResultPromise(this, templateStr  , _resolve);
};
...
PrefixSpan.prototype.setMaxLocalProjDBSize = function(maxLocalProjDBSize) {
  throw "not implemented by ElairJS";
//
// var templateStr = 'var {{refId}} = {{inRefId}}.setMaxLocalProjDBSize({{maxLocalProjDBSize}});';
//
// return Utils.generateAssignment(this, , templateStr , {maxLocalProjDBSize : maxLocalProjDBSize});
};
...
PrefixSpan.prototype.run = function(data) {
  ...
  return Utils.generateAssignment(this, PrefixSpanModel, templateStr, {data: Utils.prepForReplacement(data)});
};
