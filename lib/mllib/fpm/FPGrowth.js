...
function FPGrowth() {
  ...
  this.refIdP = Utils.evaluate(kernelP, FPGrowth, templateStr, null, true);
}
...
//
// return Utils.generateAssignment(this, , templateStr , {minSupport : minSupport});
};
...
//
// return Utils.generateAssignment(this, FPGrowthModel, templateStr , {data : data});
};
...
function FreqItemset(items, freq) {
  ...
  this.refIdP = Utils.evaluate(kernelP, FreqItemset, templateStr, {items: Utils.prepForReplacement(items), freq: freq}, true);
}
