...
Utils.generate = function(args) {
  ...
  var executionType;
   ...
   } else if (returnType === Number || returnType === String || args.stringify || Array.isArray(returnType)) {
  ...
  // handle target
  if (executionType == EXECUTION.RESULT_TYPE || executionType == EXECUTION.VOID_TYPE) {
    return refIdP;
  } else if (executionType == EXECUTION.ASSIGNMENT_TYPE) {
