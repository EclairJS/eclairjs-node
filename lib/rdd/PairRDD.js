...
PairRDD.fromRDD = function(rdd) {
  var templateStr = 'var {{refId}} = PairRDD.fromRDD({{rdd}});';

  return Utils.evaluate(rdd.kernelP, PairRDD, templateStr, {rdd: Utils.prepForReplacement(rdd)});
};

/**
 * Return an  * @param {PairRDD}
...
PairRDD.prototype.join = function(other, numPartitions) {
  ...
  return Utils.generateAssignment(this, PairRDD, templateStr, {other: Utils.prepForReplacement(other), numPartitions: numPartitions});
};
