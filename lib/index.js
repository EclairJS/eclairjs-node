  ...
  return {
    ...
    mllib: {
      ...
      recommendation: {
        ...
        Rating: require('./mllib/recommendation/Rating.js')(kernelP)
      },
    ...
    sql: {
      ...
      RowFactory: require('./sql/RowFactory.js')(kernelP),
      SqlDate: require('./sql/SqlDate.js'),
      SqlTimestamp: require('./sql/SqlTimestamp.js')
    },
