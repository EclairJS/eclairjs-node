...
// Local resolve functions to parse results of various types
    ...
    Row.prototype.schema = function() {
      var kernelP = gKernelP || this.kernelP;

      var StructType = require('./types/StructType.js')(kernelP);

      var StructField = require('./types/StructField.js')(kernelP);
      var Metadata = require('./types/Metadata.js')(kernelP);
      var DataTypes = require('./types/DataTypes.js')(kernelP);
