 ...
 *
 * The remote function's return value (which has been JSON parsed already) will be passed into the local function as an
 * argument.  The local function will be executed in Node.
 *
 * Example:
 *
 * var dStream = ...;
...
DStream.prototype.foreachRDD = function(remoteFunc, bindArgs, localFunc) {
  var args = {
    ...
    method: 'foreachRDD',
    args: [
      {value: generateForeachRDDFunc(remoteFunc, 'foo'), type: 'lambda'},
